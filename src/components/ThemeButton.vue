...
<template>
    <button class="theme-btn" @click="ui.toggleTheme" :aria-label="ui.isDark ? '切换亮色模式' : '切换暗色模式'">
        <span v-if="ui.isDark" class="theme-btn__icon">
        ...
        <span v-else class="theme-btn__icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
                <path fill="currentColor"
