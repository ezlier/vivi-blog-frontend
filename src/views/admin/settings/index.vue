    ...
    <el-form v-loading="loading" label-position="top" class="settings-form">
      ...
      <el-form-item label="站长头像">
        <div class="avatar-row">
          <img
            v-if="form.name_avatar_url"
            :src="form.name_avatar_url"
      ...
      <el-form-item label="关于页 Markdown">
        ...
        <div v-else class="editor-placeholder">
          <el-button type="primary" @click="showAboutEditor = true"
            >编写关于页内容</el-button
          >
        </div>
      </el-form-item>
...
function onAvatarChange(uploadFile: UploadFile) {
  ...
  if (uploadFile.raw) {
    form.value.name_avatar_url = URL.createObjectURL(uploadFile.raw);
  }
